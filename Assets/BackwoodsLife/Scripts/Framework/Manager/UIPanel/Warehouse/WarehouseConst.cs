namespace BackwoodsLife.Scripts.Framework.Manager.UIPanel.Warehouse
{
    public static class WarehouseConst
    {
        ...
        public const string InventoryHUDItemIcon = "i-hud-item-icon";
        public const string InventoryHUDItemLabel = "i-hud-item-label";
        public const string InventoryHUDItemLabelId = "i-hud-item-id";
    }
}
